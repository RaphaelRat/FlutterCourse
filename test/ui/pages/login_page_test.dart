...
void main() {
  ...
  testWidgets('Should present no error if email valid', (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('Should present no error if password valid', (WidgetTester tester) async {
    await loadPage(tester);
